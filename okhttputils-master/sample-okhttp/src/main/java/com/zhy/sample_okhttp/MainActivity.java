...
//                .addParams("password", "123")//
                .build()//
                .execute(new GenericsCallback<Mod>(new JsonGenericsSerializator()) {
                    ...
                    @Override
                    public void onResponse(Mod response, int id) {
                        mTv.setText("onResponse:" + response.getMsg());
                    }
                });
    }
...
//        url =3.125.219.144:8443/mobileConnect/MobileConnect/authLogin.action?systemid=100009&mobile=13260284063&pipe=2&reqtime=1422986580048&ispin=2";
    ...
    public void downloadFile(View view) {
        String url = "http://pic4.nipic.com/20091117/3376018_110331702620_2.jpg";
        OkHttpUtils//
                .get()//
                .url(url)//
                .build()//
                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath(), "gson-2.2.1.png")//
                {
                    @Override
                    public void onBefore(Request request, int id) {
                    }
